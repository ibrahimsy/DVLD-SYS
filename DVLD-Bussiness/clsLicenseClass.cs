...
namespace DVLD_Bussiness
{
     ...
     */
        ...
        public enum enLicenseClass { enSmallMotorcycle = 1,enHeavyMotorcycle = 2, enOrdinary = 3, enCommercial = 4,
                                enAgricultural = 5, enSmallAndMediumBus = 6, enTruckAndHeavyVehicle = 7
        }
