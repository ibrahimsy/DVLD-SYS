...
namespace DVLD_System
{
    public partial class ctrlScheduleTest : UserControl
    {
            ...
            set
            {
                ...
                switch (_TestType)
                {
                    case clsTestType.enTestType.enVisionTest:
                        ...
                        lblScheduleTestTitle.Text = "Vision Schedule Test";
                        break;
                    case clsTestType.enTestType.enWrittinTest:
                        ...
                        gpScheduleTest.Text = this.Text;
                        lblScheduleTestTitle.Text = "Written Schedule Test";
                        break;
                    case clsTestType.enTestType.enStreetTest:
                        ...
                        gpScheduleTest.Text = this.Text;
                        lblScheduleTestTitle.Text = "Street Schedule Test";
                        break;
                }
        ...
        private bool _HandleTestAppointmentLocked()
        {
            if (_TestAppointmentInfo.IsLocked)
            {
                lblLockedTestMessage.Enabled = true;
                lblLockedTestMessage.Text = "Person Allready Sat for this Test,Appointment Locked.";
                btnSave.Enabled = false;
                dtpDate.Enabled = false;
                return false;
            }
            else
                lblLockedTestMessage.Enabled = false;
            return true;
        }
